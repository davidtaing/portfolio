...
Note: Comparing this **distant future later problem** to a **low probability now problem** like a distributed system failure mode would also be a super interesting topic. But I'll have to leave that for another day. 😊
...
A params object will buy us the option to add new params and refactor more easily. If we use it enough times, it will probably change. And when it does, we can exercise our option.
...
P.S. By the way, really like the book. That's going in my recommended list. 👍
